...
\bytes_sent_counter[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2222222222202222"
    )
        port map (
      I0 => send_byte_i_1_n_0,
      I1 => bytes_sent_counter(0),
      I2 => bytes_sent_counter(1),
      I3 => bytes_sent_counter(4),
...
sending_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000100"
        ...
        port map (
      I0 => bytes_sent_counter(0),
      I1 => bytes_sent_counter(1),
      I2 => bytes_sent_counter(4),
      I3 => bytes_sent_counter(3),
      I4 => bytes_sent_counter(2),
      O => sending_i_2_n_0
    );

...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx_viewer is
  port (
    o_byte : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx_viewer is
  signal \byte[3]_i_1_n_0\ : STD_LOGIC;
  signal \byte[5]_i_1_n_0\ : STD_LOGIC;
  ...
  signal hex_to_ascii_reg : STD_LOGIC_VECTOR ( 5 downto 3 );
  signal \^o_byte\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^o_send_byte\ : STD_LOGIC;
  signal p_0_in : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal sel0 : STD_LOGIC_VECTOR ( 3 to 3 );
  signal send_byte_i_1_n_0 : STD_LOGIC;
  signal \sending__0\ : STD_LOGIC;
  signal sending_i_1_n_0 : STD_LOGIC;
  signal sending_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \byte[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \byte[5]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \bytes_sent_counter[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \bytes_sent_counter[3]_i_1\ : label is "soft_lutpair3";
...
\byte[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
      I0 => hex_to_ascii_reg(3),
      I1 => \sending__0\,
      I2 => i_tx_busy,
      I3 => \^o_byte\(0),
      O => \byte[3]_i_1_n_0\
    );
\byte[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
      I0 => hex_to_ascii_reg(5),
      I1 => \sending__0\,
      I2 => i_tx_busy,
      I3 => \^o_byte\(1),
      O => \byte[5]_i_1_n_0\
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^o_byte\ : STD_LOGIC_VECTOR ( 4 downto 3 );
...
begin
  ...
  o_byte(6) <= \<const0>\;
  o_byte(5) <= \^o_byte\(4);
  o_byte(4 downto 3) <= \^o_byte\(4 downto 3);
  o_byte(2) <= \<const0>\;
  o_byte(1) <= \<const0>\;
  o_byte(0) <= \<const0>\;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_tx_viewer
     port map (
      ...
      i_tx_busy => i_tx_busy,
      o_byte(1 downto 0) => \^o_byte\(4 downto 3),
      o_send_byte => o_send_byte
    );
end STRUCTURE;

...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_uart_rx_interpreter is
  ...
  attribute SOFT_HLUTNM of \rx_shift_reg[71]_i_2\ : label is "soft_lutpair39";
  ...
  attribute SOFT_HLUTNM of \rx_shift_reg[79]_i_1\ : label is "soft_lutpair42";
...
\rx_shift_reg[71]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\rx_shift_reg[71]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (

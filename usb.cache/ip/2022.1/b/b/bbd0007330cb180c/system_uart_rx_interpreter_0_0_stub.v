...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(i_clk, i_new_byte, i_rx_byte, o_waddr, o_wdata, 
  o_cmd, f_editing, f_viewing)
/* synthesis syn_black_box black_box_pad_pin="i_clk,i_new_byte,i_rx_byte[7:0],o_waddr[7:0],o_wdata[31:0],o_cmd[7:0],f_editing,f_viewing" */;
  input i_clk;
  input i_new_byte;
  input [7:0]i_rx_byte;
  output [7:0]o_waddr;

...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(i_clk, i_data, i_phase_set, o_usb_clk)
/* synthesis syn_black_box black_box_pad_pin="i_clk,i_data,i_phase_set[6:0],o_usb_clk" */;
  input i_clk;
  input i_data;

...
--               c:/Users/ehussain/Desktop/Projects/usb/usb.gen/sources_1/bd/system/ip/system_uart_tx_0_0/system_uart_tx_0_0_sim_netlist.vhdl
...
entity system_uart_tx_0_0_uart_tx is
  port (
  ...
  attribute ORIG_REF_NAME of system_uart_tx_0_0_uart_tx : entity is "uart_tx";
end system_uart_tx_0_0_uart_tx;

architecture STRUCTURE of system_uart_tx_0_0_uart_tx is
  ...
  attribute SOFT_HLUTNM of \data[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data[6]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data[7]_i_3\ : label is "soft_lutpair1";
...
start_send_reg_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"CAFA"
    )
        port map (
...
entity system_uart_tx_0_0 is
  ...
  attribute NotValidForBitStream of system_uart_tx_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_uart_tx_0_0 : entity is "system_uart_tx_0_0,uart_tx,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_uart_tx_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of system_uart_tx_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_uart_tx_0_0 : entity is "uart_tx,Vivado 2022.1";
end system_uart_tx_0_0;

architecture STRUCTURE of system_uart_tx_0_0 is
...
begin
inst: entity work.system_uart_tx_0_0_uart_tx
     port map (
      i_clk => i_clk,

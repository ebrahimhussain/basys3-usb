...
HD_PWD='C:/Users/ehussain/Desktop/Projects/usb/usb.runs/system_sys_register_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_sys_register_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_sys_register_0_2.tcl
